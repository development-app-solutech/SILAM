...
{
    public class AnalyseAvecOngletCreateVM
    {
        //[Remote(action: "IsNomAvailable", controller: "AnalyseAvecOnglet")]
        ...
        public List<ParametreCreateAvecOngletVM> Parametres { get; set; } = new List<ParametreCreateAvecOngletVM>();

        public List<ValeurreferenceCreateAvecOngletVM> ValeursReference { get; set; } = new List<ValeurreferenceCreateAvecOngletVM>();

        public List<TarifanalyseassuranceCreateAvecOngletVM> TarifsAssurance { get; set; } = new List<TarifanalyseassuranceCreateAvecOngletVM>();
