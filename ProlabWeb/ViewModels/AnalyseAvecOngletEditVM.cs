...
{
    public class AnalyseAvecOngletEditVM
    {
        ...
        public List<ParametreEditAvecOngletVM> Parametres { get; set; } = new List<ParametreEditAvecOngletVM>();
        
        public List<ValeurreferenceEditAvecOngletVM> ValeursReference { get; set; } = new List<ValeurreferenceEditAvecOngletVM>();
        
        public List<TarifanalyseassuranceEditAvecOngletVM> TarifsAssurance { get; set; } = new List<TarifanalyseassuranceEditAvecOngletVM>();
