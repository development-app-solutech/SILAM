...
namespace ProlabWeb.Areas.Identity.Pages.Account.Manage
{
    public class EmailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            {
                StatusMessage = "L'email saisi est identique à l'email actuel.";
                return Page();
            }
            var setEmailResult = await _userManager.SetEmailAsync(user, NouvelEmail);
            if (!setEmailResult.Succeeded)
            {
                StatusMessage = "Erreur lors du changement d'email.";
                return Page();
            }
            StatusMessage = "Votre email a été modifié avec succès.";
