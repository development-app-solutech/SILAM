...
var KTEntetematerielapproList = function () {
    var table;
    var datatable;
    var loader;
    ...
    var handleSearchDatatable = function () {
        const filterSearch = document.querySelector('[data-kt-entetematerielappro-table-filter="search"]');
        if (filterSearch) {
    ...
    var handlePrint = function () {
        ...
        printLinks.forEach(d => {
            d.addEventListener('click', function (e) {
                e.preventDefault();
                $.ajax({
                    url: '/EnteteMaterielAppro/PrintList',
                    type: 'POST',
                    beforeSend: function () {
    ...
    var handleDeleteRows = function () {
        const deleteButtons = document.querySelectorAll('[data-kt-entetematerielappro-table-filter="delete_row"]');
        deleteButtons.forEach(d => {
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        let id = $(d).data('id');
                        console.log('Suppression entetematerielappro id :', id); // LOG
                        // R̩cup̩rer le token anti-forgery
                        var token = $('input[name="__RequestVerificationToken"]').val();
                        $.ajax({
                            url: '/EnteteMaterielAppro/DeleteAjax',
                            type: 'POST',
                            ...
                            success: function (response) {
                                ...
                                if (response.success) {
                                    ...
                                    Swal.fire({
                                        text: "Ent̻te mat̩riel appro supprim̩(e) avec succ̬s!",
                                        icon: "success",
                                        buttonsStyling: false,
    ...
    return {
        init: function () {
            console.log('KTEntetematerielapproList.init appel̩'); // LOG
            table = document.querySelector('#kt_table_entetematerielappro_index');
            if (!table) return;
            loader = document.querySelector('#kt_spinner_entetematerielappro_index');
...
document.addEventListener('DOMContentLoaded', function () {
    if (typeof KTEntetematerielapproList !== 'undefined') {
        KTEntetematerielapproList.init();
    }
});
