...
var KTSiteList = function () {
    ...
    var handleSearchDatatable = function () {
        const filterSearch = document.querySelector('[data-kt-site-table-filter="search"]');
        if (filterSearch) {
    ...
    var handleDeleteRows = function () {
        const deleteButtons = document.querySelectorAll('[data-kt-site-table-filter="delete_row"]');
        deleteButtons.forEach(d => {
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        let id = $(d).data('id');
                        console.log('Suppression site id :', id); // LOG
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                if (response.success) {
                                    ...
                                    Swal.fire({
                                        text: "Site supprim̩(e) avec succ̬s!",
                                        icon: "success",
                                        buttonsStyling: false,
    ...
    return {
        init: function () {
            console.log('KTSiteList.init appel̩'); // LOG
            table = document.querySelector('#kt_table_site_index');
            if (!table) return;
            loader = document.querySelector('#kt_spinner_site_index');
...
document.addEventListener('DOMContentLoaded', function () {
    if (typeof KTSiteList !== 'undefined') {
        KTSiteList.init();
    }
});
