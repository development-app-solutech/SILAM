...
var KTTarifanalyseassuranceList = function () {
    ...
    var handleDeleteRows = () => {
        ...
        const deleteButtons = table.querySelectorAll('[data-kt-tarifanalyseassurances-table-filter="delete_row"]');
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            url: `/Tarifanalyseassurance/DeleteTarifanalyseassurance?id=${id}`,
                            type: 'POST',
                            beforeSend: function () {
    ...
    return {
        // Public functions  
        init: function () {
            table = document.querySelector('#kt_table_tarifanalyseassurance_index');
            if (!table) {
                return;
            }

            loader = document.querySelector('#kt_spinner_tarifanalyseassurance_index');
...
//    KTTarifanalyseassuranceList.init();
//});