...
var KTTypepeauList = function () {
    ...
    var handleSearchDatatable = function () {
        const filterSearch = document.querySelector('[data-kt-typepeau-table-filter="search"]');
        if (filterSearch) {
    ...
    var handleDeleteRows = function () {
        const deleteButtons = document.querySelectorAll('[data-kt-typepeau-table-filter="delete_row"]');
        deleteButtons.forEach(d => {
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        let id = $(d).data('id');
                        console.log('Suppression typepeau id :', id); // LOG
                        // R̩cup̩rer le token anti-forgery
                        var token = $('input[name="__RequestVerificationToken"]').val();
                        $.ajax({
                            url: '/TypePeau/DeleteAjax',
                            type: 'POST',
                            ...
                            success: function (response) {
                                ...
                                if (response.success) {
                                    ...
                                    Swal.fire({
                                        text: "Type peau supprim̩(e) avec succ̬s!",
                                        icon: "success",
                                        buttonsStyling: false,
    ...
    return {
        init: function () {
            console.log('KTTypepeauList.init appel̩'); // LOG
            table = document.querySelector('#kt_table_typepeau_index');
            if (!table) return;
            loader = document.querySelector('#kt_spinner_typepeau_index');
...
document.addEventListener('DOMContentLoaded', function () {
    if (typeof KTTypepeauList !== 'undefined') {
        KTTypepeauList.init();
    }
});
