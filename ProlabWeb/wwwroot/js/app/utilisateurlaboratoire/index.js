...
var KTUtilisateurlaboratoireList = function () {
    var table;
    var datatable;
    var loader;
    ...
    var handleSearchDatatable = function () {
        const filterSearch = document.querySelector('[data-kt-utilisateurlaboratoire-table-filter="search"]');
        if (filterSearch) {
    ...
    var handlePrint = function () {
        const printLinks = document.querySelectorAll('[data-kt-list-utilisateurlaboratoire-table-print="print_table"]');
        printLinks.forEach(d => {
            d.addEventListener('click', function (e) {
                e.preventDefault();
                $.ajax({
                    url: '/UtilisateurLaboratoire/PrintList',
                    type: 'POST',
                    beforeSend: function () {
    ...
    var handleDeleteRows = function () {
        const deleteButtons = document.querySelectorAll('[data-kt-utilisateurlaboratoire-table-filter="delete_row"]');
        deleteButtons.forEach(d => {
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        let id = $(d).data('id');
                        console.log('Suppression utilisateurlaboratoire id :', id); // LOG
                        // R̩cup̩rer le token anti-forgery
                        var token = $('input[name="__RequestVerificationToken"]').val();
                        $.ajax({
                            url: '/UtilisateurLaboratoire/DeleteAjax',
                            type: 'POST',
                            ...
                            success: function (response) {
                                ...
                                if (response.success) {
                                    ...
                                    Swal.fire({
                                        text: "Utilisateur laboratoire supprim̩(e) avec succ̬s!",
                                        icon: "success",
                                        buttonsStyling: false,
    ...
    return {
        init: function () {
            console.log('KTUtilisateurlaboratoireList.init appel̩'); // LOG
            table = document.querySelector('#kt_table_utilisateurlaboratoire_index');
            if (!table) return;
            loader = document.querySelector('#kt_spinner_utilisateurlaboratoire_index');
...
document.addEventListener('DOMContentLoaded', function () {
    if (typeof KTUtilisateurlaboratoireList !== 'undefined') {
        KTUtilisateurlaboratoireList.init();
    }
});
