...
var KTLoboratoireList = function () {
    var table;
    var datatable;
    var loader;
    ...
    var handleSearchDatatable = function () {
        const filterSearch = document.querySelector('[data-kt-loboratoire-table-filter="search"]');
        if (filterSearch) {
    ...
    var handleDeleteRows = function () {
        const deleteButtons = document.querySelectorAll('[data-kt-loboratoire-table-filter="delete_row"]');
        deleteButtons.forEach(d => {
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        let id = $(d).data('id');
                        console.log('Suppression loboratoire id :', id); // LOG
                        // R̩cup̩rer le token anti-forgery
                        var token = $('input[name="__RequestVerificationToken"]').val();
                        $.ajax({
                            url: '/Loboratoire/DeleteAjax',
                            type: 'POST',
                            ...
                            success: function (response) {
                                ...
                                if (response.success) {
                                    ...
                                    Swal.fire({
                                        text: "Laboratoire supprim̩(e) avec succ̬s!",
                                        icon: "success",
                                        buttonsStyling: false,
    ...
    return {
        init: function () {
            console.log('KTLoboratoireList.init appel̩'); // LOG
            table = document.querySelector('#kt_table_loboratoire_index');
            if (!table) return;
            loader = document.querySelector('#kt_spinner_loboratoire_index');
...
document.addEventListener('DOMContentLoaded', function () {
    if (typeof KTLoboratoireList !== 'undefined') {
        KTLoboratoireList.init();
    }
});
