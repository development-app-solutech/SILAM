$(document).ready(function () {
    ...
    $('#btnRecherche').on('click', function (e) {
        ...
        $("iframe[data-rapport='recetteparjourparpartenaire']").remove();
        
        $.ajax({
            url: '/Rapport/GenererRecetteParJourParPartenaire',
            type: 'GET',
            data: { date: date },
            beforeSend: function() {
                $('#loader-spinner').show();
            ...
            success: function (data) {
                if (data.success) {
                    ...
                    printFrame.setAttribute('data-rapport', 'recetteparjourparpartenaire');
