...
$(document).ready(function () {
    ...
    $('#btnRecherche').on('click', function (e) {
        ...
        $("iframe[data-rapport='recetteparperiode']").remove();
        
        $.ajax({
            url: '/Rapport/GenererRecetteParPeriode',
            type: 'GET',
            data: { debut: debut, fin: fin, typeClient: typeClient },
            beforeSend: function() {
                $('#loader-spinner').show();
            },
            success: function (data) {
                if (data.success) {
                    ...
                    printFrame.setAttribute('data-rapport', 'recetteparperiode');
