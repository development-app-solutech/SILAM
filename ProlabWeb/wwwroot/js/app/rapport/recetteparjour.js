$(document).ready(function () {
    ...
    $('#btnRecherche').on('click', function (e) {
        ...
        $("iframe[data-rapport='recetteparjour']").remove();
        
        $.ajax({
            url: '/Rapport/GenererRecetteParJour',
            type: 'GET',
            data: { date: date, typeClient: typeClient },
            beforeSend: function() {
                $('#loader-spinner').show();
            },
            success: function (data) {
                ...
                if (data.success) {
                    ...
                    printFrame.setAttribute('data-rapport', 'recetteparjour');
