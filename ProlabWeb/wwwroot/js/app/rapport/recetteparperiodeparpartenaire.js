$(document).ready(function () {
    ...
    $('#btnRecherche').on('click', function (e) {
        ...
        $("iframe[data-rapport='recetteparperiodeparpartenaire']").remove();
        
        $.ajax({
            url: '/Rapport/GenererRecetteParPeriodeParPartenaire',
            type: 'GET',
            ...
            success: function (data) {
                if (data.success) {
                    ...
                    printFrame.setAttribute('data-rapport', 'recetteparperiodeparpartenaire');
