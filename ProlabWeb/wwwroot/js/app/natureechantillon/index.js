...
var KTNatureechantillonList = function () {
    var table;
    var datatable;
    var loader;
    ...
    var handleSearchDatatable = function () {
        const filterSearch = document.querySelector('[data-kt-natureechantillon-table-filter="search"]');
        if (filterSearch) {
    ...
    var handlePrint = function () {
        ...
        printLinks.forEach(d => {
            d.addEventListener('click', function (e) {
                e.preventDefault();
                $.ajax({
                    url: '/NatureEchantillon/PrintList',
                    type: 'POST',
                    beforeSend: function () {
    ...
    var handleDeleteRows = function () {
        const deleteButtons = document.querySelectorAll('[data-kt-natureechantillon-table-filter="delete_row"]');
        deleteButtons.forEach(d => {
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        let id = $(d).data('id');
                        console.log('Suppression natureechantillon id :', id); // LOG
                        // R̩cup̩rer le token anti-forgery
                        var token = $('input[name="__RequestVerificationToken"]').val();
                        $.ajax({
                            url: '/NatureEchantillon/DeleteAjax',
                            type: 'POST',
                            ...
                            success: function (response) {
                                ...
                                if (response.success) {
                                    ...
                                    Swal.fire({
                                        text: "Nature ̩chantillon supprim̩(e) avec succ̬s!",
                                        icon: "success",
                                        buttonsStyling: false,
    ...
    return {
        init: function () {
            console.log('KTNatureechantillonList.init appel̩'); // LOG
            table = document.querySelector('#kt_table_natureechantillon_index');
            if (!table) return;
            loader = document.querySelector('#kt_spinner_natureechantillon_index');
...
document.addEventListener('DOMContentLoaded', function () {
    if (typeof KTNatureechantillonList !== 'undefined') {
        KTNatureechantillonList.init();
    }
});
